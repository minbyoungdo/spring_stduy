  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
     ...
     <c:choose>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./User_Login"><font style="vertical-align: inherit;"><font style="vertical-align: inherit; color:black;">로그인</font></font></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./User_Drink_Menu"><font style="vertical-align: inherit;"><font style="vertical-align: inherit; color:black;">목록</font></font></a>
        </li>
       </c:when>
        <c:otherwise>
         	<li class="nav-item">
